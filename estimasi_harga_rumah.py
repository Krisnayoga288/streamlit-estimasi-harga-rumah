...
Luas_Bangunan = st.number_input('Masukan Luas Bangunan (m2)')
Luas_Tanah 	= st.number_input('Masukan Luas Tanah (m2)')
Kamar_Tidur = st.number_input('Masukan Jumlah Kamar Tidur')
Kamar_Mandi = st.number_input('Masukan Jumlah kamar Mandi')
Kategori_Garasi = st.number_input('Kategori Garasi (m2)')
